...
export const COUNTRY_COORDS: Record<string, CountryCoord> = {
  ...
  // Remaining sovereign states (centroids; globe-scale precision).
  ...
  // Financial-center territories / dependencies seen in payment flows.
